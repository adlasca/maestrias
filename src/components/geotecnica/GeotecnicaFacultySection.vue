...
<template>
  <section id="facultad" class="py-24 bg-gradient-to-r from-green-400  to-purple-700 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
      ...
      <div class="text-center mb-20">
        ...
        <h2 class="text-4xl md:text-6xl font-black text-white mb-6 tracking-tight">
          Mentores <span class="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-red-400">Certificados</span>
        </h2>
