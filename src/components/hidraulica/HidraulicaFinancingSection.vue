    ...
    <div class="container mx-auto px-4 relative z-10">
      ...
      <div class="max-w-4xl mx-auto bg-slate-900 rounded-2xl border border-white/10 overflow-hidden">
        <div class="grid md:grid-cols-2">
          ...
          <div class="bg-gradient-to-br from-cyan-900/50 to-blue-900/50 p-8 md:p-12 flex flex-col justify-center items-center text-center relative">
            ...
            <div class="flex flex-col w-full gap-3 relative z-10">
              <a href="https://wa.me/593999072657" target="_blank" 
                 class="w-full py-3 px-6 rounded-xl bg-white text-cyan-900 font-bold hover:bg-cyan-50 transition-colors flex items-center justify-center gap-2">
